let modelsJson = [
    {id:1, name:'x-tudo', img:'img/F4FWildcat.png', price:[100.00, 150.00, 200.00], sizes:['1/72', '1/48', '1/32'], description:'Caça utilizado nos primeiros anos de combate no pacífico pela marinha dos EUA'},
    {id:2, name:'x-egg', img:'img/Fw190A5.png', price:[100.00, 150.00, 200.00], sizes:['1/72', '1/48', '1/32'], description:'Caça de motor em estrela da Luftwaffe, temido em médias e baixas altitudes'},
    {id:3, name:'x-bacon', img:'img/Ki61Hien.png', price:[100.00, 150.00, 200.00], sizes:['1/72', '1/48', '1/32'], description:'Caça fabricado pela Kawasaki para o exercito japones, com motor em linha'},
    {id:4, name:'pizza', img:'img/Me109G6.png', price:[100.00, 150.00, 200.00], sizes:['1/72', '1/48', '1/32'], description:'Famoso caça da Messerchmitt, voado pelos maiores ases da Luftwaffe, a versão G foi a mais produzida'},
    {id:5, name:'pizza portuguersa- Thunderbolt', img:'img/P47D.png', price:[100.00, 150.00, 200.00], sizes:['1/72', '1/48', '1/32'], description:'Caça bombardeiro de fabricação americana utilizado pela FAB'},
    {id:6, name:'refrigerante 2litros', img:'img/P51D.png', price:[100.00, 150.00, 200.00], sizes:['1/72', '1/48', '1/32'], description:'O mais conhecido caça americano, importante escolta para os bombardeiros diurnos'},
    {id:7, name:'coca lata 350ml', img:'img/SpitMk9.png', price:[100.00, 150.00, 200.00], sizes:['1/72', '1/48', '1/32'], description:'O mais famosa caça britânico, utilizado em toda a guerra'},
    {id:8, name:'batata frita', img:'img/Zero.png', price:[100.00, 150.00, 200.00], sizes:['1/72', '1/48', '1/32'], description:'O mais famoso caça da marinha japonesa, terror do pacífico nos anos iniciais da guerra'}
];
...
modelsJson.map((item, index)=>{
    ...
    modelsItem.querySelector('a').addEventListener('click', (e)=>{
        ...
        c('.modelsInfo--actualPrice2').innerHTML = `R$ ${modelsJson[key].price[0].toFixed(2)}`;
...
cs('.modelsInfo--size').forEach((size, sizeIndex)=>{
    size.addEventListener('click', (e)=> {
        ...
        size.classList.add('selected');
        c('.modelsInfo--actualPrice').innerHTML = `R$ ${modelsJson[key].price[sizeIndex].toFixed(2)}`;
        c('.modelsInfo--actualPrice2').innerHTML = `R$ ${modelsJson[key].price[sizeIndex].toFixed(2)}`;
    });
});
...
var produtosIntTitulo = document.getElementsByClassName(".cart");
var orcamentoAssuntoForm = document.getElementById(".cart--item-nome");
